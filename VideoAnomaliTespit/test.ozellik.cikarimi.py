...
class Simple3DCNN(nn.Module):
    def __init__(self):
        ...
        # Fully connected katmanı giriş boyutu bilinmiyor, dinamik olarak hesaplayacağız
        self.fc = None
    ...
    def forward(self, x):
        ...
        if self.fc is None:
            ...
            self.fc = nn.Linear(num_features, 512).to(x.device)  # Fully connected katmanı burada tanımlanır
...
segment_dir = 'C:/Users/RAMAZAN/Desktop/VideoTespit/TestEtiketliNpy'
output_dir = 'C:/Users/RAMAZAN/Desktop/VideoTespit/TestFeatures'
